...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Введите в консоли адрес .txt файла в следующем формате D:/Desktop/doc1.txt  или в формате имя_файла.txt, если файл находится в корневом каталоге проекта: ");
